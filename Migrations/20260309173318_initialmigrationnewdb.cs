...
namespace Clinic_appointment.Migrations
{
    ...
    public partial class initialmigrationnewdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScheduleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    EffFrom = table.Column<DateOnly>(type: "date", nullable: false),
                    EffTo = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorAvailabilities_DoctorId_AvailabilityDate",
                table: "DoctorAvailabilities",
                columns: new[] { "DoctorId", "AvailabilityDate" });
